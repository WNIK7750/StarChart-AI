...
开始前必须阅读：
1. docs/users-area-optimization-guide.md
2. docs/users-area-task-backlog.md
3. docs/project-wide-optimization-roadmap.md
4. docs/user-module-design.md（仅作为早期模型参考，发现与代码冲突时以当前代码和新指导为准）
5. docs/learning-area-implementation.md
...
首批验收目标：
- 完成 docs/users-area-task-backlog.md 中 USR-001 至 USR-105。
