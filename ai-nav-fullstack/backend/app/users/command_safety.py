...
COMMAND_SAFETY: dict[tuple[str, str], CommandSafetySpec] = {
    ...
    ("POST", "/api/v1/auth/password-reset/security/start"): _spec("authentication", "users.auth.password_reset_started", "rate-limit+challenge-uid", "transaction"),
    ("POST", "/api/v1/auth/password-reset/security/verify"): _spec("authentication", "users.auth.password_reset_verified", "single-use-challenge", "transactional-consume"),
    ("POST", "/api/v1/auth/password-reset/security/confirm"): _spec("authentication", "users.auth.password_reset_completed", "single-use-token", "transactional-consume+session-revoke"),
